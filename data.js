...
window.SITE = {
  ...
  projects: [
    ...
    },
    {
      ...
      meta: [['Status', 'Pre-data · lit review'], ['Design', 'Two-stage, chained'], ['Demand ID', 'Ukraine-invasion event study'], ['Support', 'GPR-index panel (user + time FE)'], ['Control', 'Cozy games'], ['Supply', 'Genre panel · event study'], ['Data', 'Steam public reviews · R']],
      ...
      body: [
        ...
        'Rather than chase the whole chain with a single instrument, it splits into two stages that can each be identified on their own. The demand stage asks whether rising dread shifts consumption — measured as a within-user shift in how much of someone’s Steam reviewing goes to survival games. Its headline test treats the February 2022 invasion of Ukraine as a sudden jump in global dread and reads the response as an event study, backed by a panel tied to the Caldara–Iacoviello geopolitical-risk index with user and time fixed effects, and cozy games held as the control genre. The supply stage asks whether that success drives entry, through a genre-level panel and event studies around breakout hits.',
    ...
    },
    {
      ...
      s: [['150+', 'entries', 'o'], ['10', 'tracks']],
      meta: [['Entries', '150+'], ['Tracks', '10'], ['Format', 'Quarto'], ['Published', 'GitHub Pages'], ['Source', 'Private']],
      ...
      body: [
        ...
        'More than 150 entries — articles across ten tracks, from an overture and foundations through inference, regression, prediction, causal inference and field realities, plus standalone tracks on complexity, dataframes and machine learning, and appendices on the maths and computing.',
  ...
  experience: [
    ...
    { yr: '2024–25', t: 'Undergraduate Research Assistant, Extending the Republic of Beliefs', org: 'Multi-university collaboration, including Ashoka University · Remote / Sonipat', ext: 'RESEARCH', note: 'Built on Kaushik Basu’s work linking beliefs in legal enforcement to corruption, through a 15-paper literature review, a norms-elicitation survey, and logistics for the pilot experiment.' },
  ...
  repos: [
    ...
    { yr: '2026', t: 'quant-social-scientist', org: 'Rendered GitHub Pages site for The Quantitative Social Scientist — 150+ entries across ten tracks and appendices, built from a private Quarto source.', ext: '★ 0', u: 'https://github.com/profsarthak/quant-social-scientist' },
  ],
